...
export const getColumns = (refetch: () => void): ProColumns<any>[] => [
  ...
  },
  {
    ...
    width: 150,
    key:"2",
    render:(_,record:any) => record?.paid ?  <Tag color="green"> Payée </Tag>: <Tag color="red">Non Payée</Tag>  
  },
  {
    title: "Mrn",
    dataIndex: "proforma",
...
export const getPaiementColumns = (handleFactureAdd: any): ProColumns<any>[] => [
  {
    render:(_,record:any) => <Button icon={<PlusOutlined />} onClick={() => handleFactureAdd(record)}></Button>
  },
  {
    title: "Numéro",
    dataIndex: "numero",
