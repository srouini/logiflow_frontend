...
import { getDailyEarningsStats } from '@/services/billing/reporting';
...
export default () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const data = await getDailyEarningsStats();
  ...
  return (
    ...
    >
      <div style={{
        ...
        {renderStatisticCard("Today's Earnings", earningsData || undefined, loading)}
      </div>
    </RcResizeObserver>
  );
};