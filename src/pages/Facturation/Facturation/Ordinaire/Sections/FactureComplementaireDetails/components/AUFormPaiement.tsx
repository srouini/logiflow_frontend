...
import { FactureComplementaire, Paiement, PaiementFactureComplementaire } from "@/types/billing";
...
interface AUFormProps {
  ...
  paiementsFacture:PaiementFactureComplementaire[]
}

const AUFormPaiement: React.FC<AUFormProps> = ({ refetch, facture,paiementsFacture }) => {
  ...
  const calculateRest = () => {
    let total: number = 0;
    paiementsFacture?.forEach((paiement: Paiement) => {
